...
/*   Updated: 2022/05/08 21:36:33 by deacllock        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "exec.h"

static t_combo	init_combo(t_env *env, t_parser *parser, t_lexer *lexer)
{
	t_combo	combo;
...
static int	pipe(t_combo *combo, t_list *parser, t_list *cur)
{
	t_cmd	*cmd;
	t_cmd	*next;
	int		pipe_fd[2];
